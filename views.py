...
def upload_file_on_site():
    ...
    driver.find_element("id","username").send_keys("tester")
    ...
    s.send_keys("D:/Railway-Project/downloads/annual-enterprise-survey-2021-financial-year-provisional-csv.csv")
...
>>>>>>> 0437c29917239faf855461b26c569dcf8bc35193
